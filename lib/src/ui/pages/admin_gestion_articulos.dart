...
class AdminGestionArticulosMovilPage extends StatefulWidget {
  const AdminGestionArticulosMovilPage({super.key});

  @override
  State<AdminGestionArticulosMovilPage> createState() => _AdminGestionArticulosMovilPageState();
}

class _AdminGestionArticulosMovilPageState extends State<AdminGestionArticulosMovilPage> {
  // Scroll (sin footer)
