...
class AdminGestionEmpresasPageMovil extends StatefulWidget {
  const AdminGestionEmpresasPageMovil({super.key});
  @override
  State<AdminGestionEmpresasPageMovil> createState() => _AdminGestionEmpresasPageMovilState();
}

class _AdminGestionEmpresasPageMovilState extends State<AdminGestionEmpresasPageMovil> {
  ...
  // width read previously for mobile checks; no longer needed after footer removal
    return Scaffold(
